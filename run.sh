...
# python main.py --dataset pubmed --module GAE --gpu 0 --n-epochs 5000  --seed 46 --early-stop
...
# python main.py --dataset cora --module GAE --gpu 0 --n-epochs 5000  --seed 46 --early-stop
